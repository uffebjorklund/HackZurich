namespace HackZurich.Local.Scaling
{
    using System;
    ...
    /// </summary>
    [Export(typeof(IXSocketsScaleOut))]
    public class AzureServiceBusScaleOut : BaseScaleOut
    {
        ...
        public override void Init()
        {
            ...
            {  
                ...
                this.SID = Composable.GetExport<IXSocketServerContainer>().ContainerId.ToString(); //ConfigurationManager.AppSettings.Get("XSockets.Scaleout.ServerId");
